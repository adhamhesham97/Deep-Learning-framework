...
Features_Train_small = Features_Train[0:10000] #choose the first 1000 examples only
...
predicted_labels = np.argmax(model.predict(Features_Train_small[0:1000]), axis=0)
